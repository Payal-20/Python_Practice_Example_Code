...
int main(){
	...
	head = NULL;
	insertfirst(5,"Season Fruits",23,120.23);
	insertfirst(4,"Jack Fruits",50,300);
	insertfirst(3,"Fruit Salad",100, 150);
	insertfirst(2,"Fruit Juice",23,220);
	...
	if((main_menu_choice >=1 && main_menu_choice <=3)){
		...
		if(main_menu_choice == 1){
			...
			if(admin_panel_choice==12345678){
				...
				cls();  br(3); pre(4); echo(">>>> Admin Dashboard <<<<   \n\n");
				pre(4);
				printf(" 1. Total Cash Today \n\n");Sleep(250);pre(4);
				printf(" 2. View Card Pay \n\n");Sleep(250);pre(4);
				printf(" 3. Add Fruits in Stock \n\n");Sleep(250);pre(4);
				printf(" 4. Delete Fruits from Stock \n\n");Sleep(250);pre(4);
				printf(" 5. Instant Fruit Stock List \n\n");Sleep(250);pre(4);
				...
				if(adminchoise==1){
					...
					br(3);pre(4);      printf(" Enter Type of Fruit Name :  ");
					...
					scanf("%d",&fquantity); fflush(stdin);
                        ...
                        foodserial:
					br(2);pre(4);  printf(" Enter Fruit Serial :  ");
                      scanf("%d",&fdata);
                            node *exist;
                            exist = list;
...
void main_menu(){
	...
	cls();
	br(5); pre(3); echo(">> 1. View List"); Sleep(400);
	br(2); pre(3); echo(">> 2. Admin Dashboard"); Sleep(400);
...
void backuploader(void){
	...
	for (int i=15;i<=100;i+=5){
		...
		printf("\n\n\n\n\n\n\n\t\t\t\t");
		printf("%d %% Backing up the data keep patience...\n\n\t\t",i);
